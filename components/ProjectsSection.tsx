...
function ProjectMedia({ project }: { project: ShowcaseProject }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative h-full w-full overflow-hidden rounded-xl bg-black/[0.03] shadow-[0_24px_60px_-24px_rgba(0,0,0,0.35)]">
        {isVideo ? (
          <video
            ref={videoRef}
  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col ${reversed ? "md:order-2" : ""}`}>
        ...
        <a
          href="#contact"
          className="group mt-8 inline-flex w-fit items-center gap-2 rounded-full bg-[#1A1A1A] px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#333]"
        >
